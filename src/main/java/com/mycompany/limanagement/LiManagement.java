package com.mycompany.limanagement;
...
/**
 *
 * @author Geeks4Learning
 */
public class LiManagement {
...
try {
        ...
        Connection con = DriverManager.getConnection("jdbc:mysql://localhost/mysql?user=root&password=123");
        return con;
 } 
 catch (Exception ex) {
        ex.printStackTrace();
...
return null;
    ...
    //iterate each catalog in the ResultSet
        ...
        Statement stmt = connection.createStatement();
          ...
          stmt.executeUpdate("INSERT INTO BOOKS(BNAME, GENRE, PRICE) VALUES ('War and Peace', 'Mystery', 150),  ('The Guest Book', 'Fiction', 300), ('The Perfect Murder','Mystery', 150), ('Accidental Presidents', 'Biography', 250)");
        ...
        public void actionPerformed(ActionEvent e){
                ...
                create_but.addActionListener(new ActionListener() {
                    ...
                    Statement stmt = connection.createStatement();
                     ...
                     ResultSet rs = stmt.executeQuery("SELECT ISSUED_DATE FROM ISSUED WHERE IID="+iid);   // iid - issue id
                     while (rs.next()) {
